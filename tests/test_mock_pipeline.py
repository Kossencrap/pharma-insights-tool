...
def test_mock_data_pipeline(tmp_path: Path) -> None:
    ...
    _run_module(
        ...
        str(db_path),
        "--products",
        str(repo_root / "config" / "mock_products.json"),
        "--study-weights",
    ...
    expected_files = [
        ...
        "narratives_change_m.parquet",
        "narratives_weighted_w.parquet",
        "narratives_weighted_m.parquet",
        "narratives_dimensions_w.parquet",
        "narratives_dimensions_m.parquet",
        "directional_w.parquet",
        "directional_m.parquet",
        "risk_signals_w.parquet",
        "risk_signals_m.parquet",
        "sentiment_w.parquet",
        "sentiment_m.parquet",
